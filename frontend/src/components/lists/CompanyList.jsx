...
export default function CompanyList({ companies, onView, onEdit, onDelete }) {
  ...
  return (
    <div className="card">
          ...
          <thead className="bg-gray-50">
            <tr>
              ...
              >
                <div className="flex items-center">
                  Registration Date
                  {sortField === "registrationDate" && <ArrowsUpDownIcon className="ml-1 h-4 w-4" />}
                </div>
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                Contact Person
              ...
              >
                <div className="flex items-center">
                  Employees
                  {sortField === "employeeCount" && <ArrowsUpDownIcon className="ml-1 h-4 w-4" />}
                </div>
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                Actions
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {paginatedCompanies.map((company) => (
              <tr key={company.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{company.employeeCount}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  <div className="flex space-x-2">
                    ...
                    <button onClick={() => onEdit(company)} className="text-blue-600 hover:text-blue-900" title="Edit">
      ...
      {companies.length === 0 && <div className="text-center py-4 text-gray-500">No company records found.</div>}
